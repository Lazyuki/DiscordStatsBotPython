...
async def wait_for_reaction(client: discord.client, message: discord.Message, reaction: str, user_id: int=None, timeout=300.0, triple_click=False, minimo=False, wp=False):
    """
