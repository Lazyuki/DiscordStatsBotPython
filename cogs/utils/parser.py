...
async def asking_vc(message):
    ...
    if vc and asking:
        await message.reply(
            f'As mentioned in <#189585230972190720>, you need a language role to join voice chat. Please say what your native language is {"here" if message.channel.id == 189571157446492161 else "in <#189571157446492161>"}',
            mention_author=True,
        )
